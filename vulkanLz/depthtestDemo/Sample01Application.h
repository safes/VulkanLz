...
private:
	...
	std::array<vertexIn, 8> vertices = {
		glm::vec3(-0.5, -0.5,0.f),glm::vec3{1.f,0.f,0.f},glm::vec2{0,0},
		glm::vec3{0.5, -0.5,0.f},glm::vec3{1.f,1.f,0.f},glm::vec2{1,0},
		glm::vec3(0.5, 0.5,0.f),glm::vec3{1.f,1.f,0.f}, glm::vec2{1,1},
		glm::vec3(-0.5, 0.5,0.f),glm::vec3{1.f,0.f,0.f}, glm::vec2{0,1},

		glm::vec3(-0.5, -0.5,-0.5f),glm::vec3{1.f,0.f,0.f},glm::vec2{0,0},
		glm::vec3{0.5, -0.5,-0.5f},glm::vec3{1.f,1.f,0.f},glm::vec2{1,0},
		glm::vec3(0.5, 0.5,-0.5f),glm::vec3{1.f,1.f,0.f}, glm::vec2{1,1},
		glm::vec3(-0.5, 0.5,-0.5f),glm::vec3{1.f,0.f,0.f}, glm::vec2{0,1} };
