...
void Sample01Application::createDepthResources()
{
	...
	createImage(swapchainExtend.width, swapchainExtend.height, depthformat,
...
void Sample01Application::createImageViews()
{
	...
	for (auto& image : swapChainImages) {
		swapChainImageView[i++] = createImageView(image, swapchainFormat, VK_IMAGE_ASPECT_COLOR_BIT);
	}
